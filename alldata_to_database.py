...
# Connect to MongoDB
client = MongoClient('mongodb+srv://unipolar:12345@cluster0.dhy44zc.mongodb.net/')
...
def insert_bse_csv_data():
    ...
    csv_files = [f for f in os.listdir('C:/Users/balar/OneDrive/Desktop/scrap files/stocks_datageneration/BSE_STOCKS') if f.endswith('.csv')]
    ...
    for file in csv_files:
        ...
        try:
            data = pd.read_csv(f'C:/Users/balar/OneDrive/Desktop/scrap files/stocks_datageneration/BSE_STOCKS/{file}')
...
def insert_nse_csv_data():
    # List all CSV files in a directory
    csv_files = [f for f in os.listdir('C:/Users/balar/OneDrive/Desktop/scrap files/STOCKS_DATAGENERATION/NSE_STOCKS') if f.endswith('.csv')]
    ...
    for file in csv_files:
        ...
        try:
            data = pd.read_csv(f'C:/Users/balar/OneDrive/Desktop/scrap files/STOCKS_DATAGENERATION/NSE_STOCKS/{file}')
            records = data.to_dict(orient='records')
            collection.insert_many(records)
            print(f'{len(records)} records inserted into {collection_name} collection')
        except TypeError:
